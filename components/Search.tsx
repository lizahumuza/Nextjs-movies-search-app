...
//states-input query, movies
    ...
    const searchMovies = async (e) => {
        ...
        const url='https://api.themoviedb.org/3/search/movie?&query=fast and furious&api_key=74c1d56d75920a478c87d4728a25af08&language=en-US&page=1&include_adult=false'
